...
(function () {
    ...
    if (this.Stripe.stripejs_ua = "stripe.js/6c4e062", !this.Stripe._isChannel && true) try {
                ...
                if (!x) {
                    ...
                    try {
                        d = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),
                            x = Array.prototype.slice.call(d.GetVariable("$version").match(/(\d+),(\d+),(\d+),(\d+)/), 1), d = null
                    } catch (e) {}
                }
                if (!x) return !1;
    ...
    function () {
        ...
        b = (new Date).getTime(), a = !1, this.Stripe.isDoubleLoaded || (this.Stripe.ajaxJSONP = function (d) {
            ...
            return null == d && (d = {}), g = "sjsonp" + ++b, j = document.createElement("script"), f = null, e = function (a) {
                ...
                abort: e
            }, null == a ? void l.abort() : (j.onerror = function () {
