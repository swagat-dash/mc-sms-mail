            ...
            <div class="intro-y inbox box mt-5">
                ...
                <div class="overflow-x-auto sm:overflow-x-visible myTable">
                    @forelse (App\Models\EmailContact::where('owner_id', Auth::user()->id)->Active()->whereNotNull('email')->get() as $email)
                        <div class="intro-y">
                            <div class="inline-block sm:block text-gray-700 dark:text-gray-500 bg-gray-100 dark:bg-dark-1 border-b border-gray-200 dark:border-dark-1">
                                <div class="flex px-5 py-3">
                                    <div class="w-56 flex-none flex items-center mr-10">
                                        <input class="input flex-none border border-gray-500 checking" data-id="{{ $email->id }}"  data-email="{{ $email->email }}" name="check" type="checkbox">
